...
def publish(client):
 ...
 "data": {
    ...
    "appere_ele": 0.0,
    "temperature_env": 0.0,
    "speed_ope": 1500*(1-math.e**(-0.1*(datetime.datetime.now().timestamp()-current.timestamp()))),
    # "speed_ope": 0.0,
    "speedsp_ope": 1500,
    "downtime_ope": 0.0,
    ...
    "stoptime_ope": 1720414546.107115,
        ...
        status = result[0]
        if status == 0:
            print(1500*(1-math.e**(-0.05*(datetime.datetime.now().timestamp()-current.timestamp()))))
        else:
